-- Função pra apagar os dados de todas as tabelas
...
-- Funções para ver os dados da tabela
...
SELECT * FROM espaco;
SELECT * FROM tipoespaco;
SELECT * FROM analiseReserva;
...
INSERT INTO usuario(
	...
	VALUES ('Talles', 28999097419, 'tallesAdmin@email.com', 123);
...
-- Add avaliação pré preenchida para reserva confirmada
...
VALUES (
    ...
    '2025-08-06',                       -- dtUso
    '17:42:00',                         -- horaFim
    'Campeonato de farmar aura',    -- finalidade
    NOW(),                              -- dtSolicitacao
    NULL,                               -- dtCancelamento
    NULL,                               -- dtConfirmacao
    30,                                 -- qtdPessoas
